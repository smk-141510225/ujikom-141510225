               ...
               <div class="col-md-6 "> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <div class="dropdown"> 
                                  <a href="#" class="dropdown-toggle btn btn-primary" data-toggle="dropdown" role="button" aria-expanded="false">Foto <span class="caret"></span> 
                                  </a> 
                       <ul class="dropdown-menu" role="menu"> 
                         <img src="assets/image/{{$data->foto}}" width="200" height="200"> 
                                  </ul> 
                              </div> 
